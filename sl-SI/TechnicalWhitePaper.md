...
- [Zahteve za blockchain aplikacije](#requirements-for-blockchain-applications) 
  ...
  - [Nizka zakasnitev](#low-latency)
  - [Zaporedna uspešnost](#sequential-performance)
  - [Vzporedna uspešnost](#parallel-performance)
- [Konsenzni algoritem (DPOS)](#consensus-algorithm-dpos) 
  - [Potrditev transakcij](#transaction-confirmation)
  - [Transakcije kot dokaz o deležu (TaPoS)](#transaction-as-proof-of-stake-tapos)
- [Računi](#accounts) 
  - [Sporočila & Vodje](#messages--handlers)
  - [Upravljanje dovoljenj na podlagi vloge](#role-based-permission-management) 
    - [Imenovana dovoljena raven](#named-permission-levels)
    - [Skupine za obdelavo imenovanih sporočil](#named-message-handler-groups)
    - [Mapiranje dovoljenj](#permission-mapping)
    - [Vrednotenje dovoljenj](#evaluating-permissions) 
      - [Privzete skupine dovoljenj](#default-permission-groups)
      - [Vzporedno vrednotenje dovoljenj](#parallel-evaluation-of-permissions)
