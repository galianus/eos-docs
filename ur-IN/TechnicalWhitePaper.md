...
اجازات اور تصدیق کا انتظام کرنے کے لیے ضروری ہے کہ ان کو تجارتی اور منطق اپلیکیشنز سے علیحدہ رکھا جائے. This enables tools to be developed to manage permissions in a general purpose manner and also provide significant opportunities for performance optimization.
