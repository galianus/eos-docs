...
EOS.IO سافٹویئر بلاک پرڈوسدز کو قانوناً اس بات کی اجازت نہیں دیتا کہ وہ دوسرے اکاونٹ تک کوئی پیغام پہنچایے. Each block producer makes their own subjective measurement of the computational complexity and time required to process a transaction. This applies whether a transaction is generated by a user or automatically by a script.
