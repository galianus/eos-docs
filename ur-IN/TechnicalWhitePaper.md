...
EOS.IO سافٹویئر اکاونٹ کیز اور اکاونٹ سے جانے والی مخصوص پیغامات کی وضاحت کرنے کی اجازت دیتا ہے. مثال کے طور پر، یہ ممکن ہے کہ ایک صارف کے پاس سماجی میڈیا کے لیے ایک اور دوسرے ایکسچینج کے لیے رسائی ممکن ہو. It is even possible to give other accounts permission to act on behalf of a user's account without assigning them keys.
