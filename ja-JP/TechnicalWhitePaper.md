...
認証と許可管理は標準化されて、アプリケーションのビジネスロジッキウからは分離されていることが必須です。 This enables tools to be developed to manage permissions in a general purpose manner and also provide significant opportunities for performance optimization.
