...
EOS.IO yazılımı, blok üreticilerinin herhangi bir hesaba herhangi bir mesajı göndermesinden yükümlü olamaz. Her blok üreticisi, bir işlemin işlemesi için gereken zamana ve hesaplamanın karmaşıklığıyla ilgili kendi öznel ölçümlerini yapar. This applies whether a transaction is generated by a user or automatically by a script.
