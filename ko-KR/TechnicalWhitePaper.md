...
- [계정 (Accounts)](#accounts) 
  ...
  - [역할 기반 권한 관리 (Role Based Permission Management)](#role-based-permission-management) 
    - [명명된 권한 레벨 (Named Permission Levels)](#named-permission-levels)
  ...
  - [키 도난으로부터 복구 (Recovery from Stolen Keys)](#recovery-from-stolen-keys)
...
- [토큰 모델과 리소스 사용 (Token Model and Resource Usage)](#token-model-and-resource-usage) 
  ...
  - [토큰의 가치로부터 트랜잭션 비용의 분리 (Separating Transaction costs from Token Value)](#separating-transaction-costs-from-token-value)
...
- [거버넌스 (Governance)](#governance) 
  ...
  - [프로토콜과 헌법의 개정 (Upgrading the Protocol & Constitution)](#upgrading-the-protocol--constitution) 
...
- [스크립트와 가상 머신 (Scripts & Virtual Machines)](#scripts--virtual-machines) 
  ...
  - [가상 머신 독립 아키텍처 (Virtual Machine Independent Architecture)](#virtual-machine-independent-architecture) 
    ...
    - [이더리움 가상머신 (EVM; Ethereum Virtual Machine)](#ethereum-virtual-machine-evm)
