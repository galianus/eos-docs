...
توسیق کاری صرف ایک مطعالاتی عمل ہے جو پیغامات کی تشخیص کے لیے استعمال ہوتا ہے. ایپلی کیشن اصل کام کر رہا ہے ۔. دونوں حساب کو حقیقی وقت میں عملانے کی ضرورت ہوتی ہے، تاہم اگر بلاکچین میں ایک بار لین دین شامل ہوا اس پر دوبارہ سے توثیق کاری کا عمل کرنے کی کوئی ضرورت نہیں ہے.
...
بٹ کون لین دین کی توثیق کاری کے لیے تمام گرہ کےماضی کا استعمال کرتا ہے جس سے ہر سال بلاک ہیڈرس کے 4MB استعمال ہوتے ہیں. ایک سیکنڈ میں دس ٹرانزکشن کے لیے، ایک جایز ثبوت کے لیے 512 بایٹ کی ضرورت ہے. دس منٹ کے وقفے کے بعد یہ بلاکچین میں اچھی طرح سے کام کرتا ہے، لیکن 3 سیکنڈ کے وقفے کے بعد یہ بلاکچین کے لیے ہلکا نہیں.

EOS.IO سافٹویئر کسی کے لیے بھی کم وزنی ثبوت بنا سکتا ہے جس کے پاس لین دین کے وقت اگر ناقابل تلافی بلاک ہیڈر موجود ہو. نیچے دیے گئے ہیش لنکڈ ساخت کو استعمال کرنے کے بعد کسی بھی لین دین کی موجودگی کا ثبوت جس کا سایہ 1024 بایٹ سے کم ہو سابت کر سکتے ہیں. اگر یہ تصور کیا جائے کہ توثیق کاری گرہ بلاک ہیڈرس کے ماضی کے دن کا ڈاٹا دو MB میں رکھتا ہے، پھر اس لین دین کو ثابت کرنے کے لیے صرف 200 بایٹ لمبا ثبوت درکار ہے.
