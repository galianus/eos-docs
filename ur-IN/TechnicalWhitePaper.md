...
ایک exchange ایپلیکیشن ڈویلپر اپنے صارفین کو ایکسچینج کی صورت دکھانے کے لئے اس کو پورا گروہ چلاتا ہے. اس ایکسچینج اپلیکیشن کو اس کی کوئی ضرورت نہیں ہے کہ سوشل میڈیا اپلیکیشنز کس صورت میں ہے. EOS.IO سافٹویئر کسی بھی مکمل گرہ کو طاقم اپلیکیشنز چلانے کی اجازت دیتا ہے. Messages delivered to other applications are safely ignored because an application's state is derived entirely from the messages that are delivered to it.
