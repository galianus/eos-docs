...
Pengeluar akan dipindahkan dari pertimbangan, jika mereka terlepas untuk menghasilkan satu blok dan tidak menghasilkan apa-apa blok dalam tempoh 24 jam yang lalu, sehingga mereka memberitahu rantaian blok akan niat mereka untuk mula menghasilkan blok sekali lagi. This ensures the network operates smoothly by minimizing the number of blocks missed by not scheduling those who are proven to be unreliable.
