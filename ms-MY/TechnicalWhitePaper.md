...
Perisian EOS.IO tidak boleh mewajibkan pengeluar blok untuk menyampaikan sebarang mesej kepada mana-mana akaun yang lain. Each block producer makes their own subjective measurement of the computational complexity and time required to process a transaction. This applies whether a transaction is generated by a user or automatically by a script.
